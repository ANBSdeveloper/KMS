IF OBJECT_ID(N'RP_PosmInvestment_Order') IS NOT NULL
BEGIN
    DROP PROCEDURE [RP_PosmInvestment_Order]
END

GO

CREATE PROC [dbo].[RP_PosmInvestment_Order] -- [RP_PosmInvestment_Order] 1, '2020-01-01', '2023-01-01', NULL
@UserId int,
@FromDate DateTime,
@ToDate DateTime,
@StaffId int = NULL
