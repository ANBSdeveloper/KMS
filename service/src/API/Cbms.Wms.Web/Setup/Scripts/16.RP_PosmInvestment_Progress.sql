IF OBJECT_ID(N'RP_PosmInvestment_Progress') IS NOT NULL
BEGIN
    DROP PROCEDURE [RP_PosmInvestment_Progress]
END

GO

CREATE PROC [dbo].[RP_PosmInvestment_Progress] -- [RP_PosmInvestment_Progress] 1, '2020-01-01', '2023-01-01', NULL
@UserId int,
@FromDate DateTime,
@ToDate DateTime,
@StaffId int = NULL
