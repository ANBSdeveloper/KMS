...
namespace Cbms.Kms.Domain.TicketInvestments
{
    public class TicketProgressMaterial : AuditedEntity
    {
        ...
        private async Task UpsertAsync(TicketProgressMaterialUpsertAction action)
        {
			...
			Photo1 = !string.IsNullOrEmpty(action.Photo1) ? await imageResizer.SaveImgFromBase64("TicketProgress", "", action.Photo1, Photo1, AppSettingsConnect.ImgSavePath, AppSettingsConnect.ImgLivePath) : "";
			Photo2 = !string.IsNullOrEmpty(action.Photo2) ? await imageResizer.SaveImgFromBase64("TicketProgress", "", action.Photo2, Photo2, AppSettingsConnect.ImgSavePath, AppSettingsConnect.ImgLivePath) : "";
			Photo3 = !string.IsNullOrEmpty(action.Photo3) ? await imageResizer.SaveImgFromBase64("TicketProgress", "", action.Photo3, Photo3, AppSettingsConnect.ImgSavePath, AppSettingsConnect.ImgLivePath) : "";
			Photo4 = !string.IsNullOrEmpty(action.Photo4) ? await imageResizer.SaveImgFromBase64("TicketProgress", "", action.Photo4, Photo4, AppSettingsConnect.ImgSavePath, AppSettingsConnect.ImgLivePath) : "";
			Photo5 = !string.IsNullOrEmpty(action.Photo5) ? await imageResizer.SaveImgFromBase64("TicketProgress", "", action.Photo5, Photo5, AppSettingsConnect.ImgSavePath, AppSettingsConnect.ImgLivePath) : "";
		}
    }
}