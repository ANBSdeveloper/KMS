...
{
    public class UpsertProductCommandHandler : UpsertEntityCommandHandler<UpsertProductCommand, GetProduct, ProductBaseDto>
    {
        private readonly IRepository<Product, int> _productRepository;

        public UpsertProductCommandHandler(IRequestSupplement supplement, IRepository<Product, int> ProductRepository) : base(supplement)
        {
            LocalizationSourceName = KmsConsts.LocalizationSourceName;
            _productRepository = ProductRepository;
        }

        protected override async Task<ProductBaseDto> HandleCommand(UpsertProductCommand request, CancellationToken cancellationToken)
        {
