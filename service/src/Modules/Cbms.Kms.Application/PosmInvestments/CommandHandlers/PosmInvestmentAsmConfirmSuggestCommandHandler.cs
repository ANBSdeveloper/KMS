...
{
    public class PosmInvestmentAsmConfirmSuggestCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentAsmConfirmSuggestCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentAsmConfirmSuggestCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentAsmConfirmSuggestCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentAsmConfirmSuggestAction(
                    IocResolver,
                    LocalizationSource,
