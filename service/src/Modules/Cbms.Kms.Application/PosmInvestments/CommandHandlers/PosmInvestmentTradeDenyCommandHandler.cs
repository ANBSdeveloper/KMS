...
{
    public class PosmInvestmentTradeDenyCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentTradeDenyCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentTradeDenyCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentTradeDenyCommand request, CancellationToken cancellationToken)
        {
