...
{
    public class PosmInvestmentSupConfirmProduceCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentSupConfirmProduceCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentSupConfirmProduceCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentSupConfirmProduceCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentSupConfirmProduceAction(
                    IocResolver,
                    LocalizationSource,
