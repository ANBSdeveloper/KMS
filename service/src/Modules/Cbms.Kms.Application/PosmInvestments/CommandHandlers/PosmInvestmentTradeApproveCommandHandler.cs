...
{
    public class PosmInvestmentTradeApproveCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentTradeApproveCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentTradeApproveCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentTradeApproveCommand request, CancellationToken cancellationToken)
        {
