...
{
    public class PosmInvestmentAsmApproveCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentAsmApproveCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentAsmApproveCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentAsmApproveCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentAsmApproveRequestAction(
                    IocResolver,
                    LocalizationSource,
                    requestData.Note));
