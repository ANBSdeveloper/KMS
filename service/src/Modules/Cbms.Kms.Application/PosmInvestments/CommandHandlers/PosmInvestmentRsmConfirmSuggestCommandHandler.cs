...
{
    public class PosmInvestmentRsmConfirmSuggestCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentRsmConfirmSuggestCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentRsmConfirmSuggestCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentRsmConfirmSuggestCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentRsmConfirmSuggestAction(
                    IocResolver,
                    LocalizationSource,
