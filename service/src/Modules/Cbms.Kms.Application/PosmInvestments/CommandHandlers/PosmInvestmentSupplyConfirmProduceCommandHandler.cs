...
{
    public class PosmInvestmentSupplyConfirmProduceCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentSupplyConfirmProduceCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentSupplyConfirmProduceCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentSupplyConfirmProduceCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentSupplyConfirmProduceAction(
                    IocResolver,
                    LocalizationSource,
