...
{
    public class PosmInvestmentTradeConfirmAcceptCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentTradeConfirmAcceptCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentTradeConfirmAcceptCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentTradeConfirmAcceptCommand request, CancellationToken cancellationToken)
        {
