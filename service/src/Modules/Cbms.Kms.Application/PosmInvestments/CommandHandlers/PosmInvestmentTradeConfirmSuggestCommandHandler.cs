...
{
    public class PosmInvestmentTradeConfirmSuggestCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentTradeConfirmSuggestCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentTradeConfirmSuggestCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentTradeConfirmSuggestCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentTradeConfirmSuggestAction(
                    IocResolver,
                    LocalizationSource,
