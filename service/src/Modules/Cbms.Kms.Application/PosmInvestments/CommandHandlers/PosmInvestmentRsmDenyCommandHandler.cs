...
{
    public class PosmInvestmentRsmDenyCommandHandler : RequestHandlerBase, IRequestHandler<PosmInvestmentRsmDenyCommand>
    {
        private readonly IRepository<PosmInvestment, int> _posmInvestmentRepository;
        private readonly DistributedLockManager _distributedLockManager;

        public PosmInvestmentRsmDenyCommandHandler(DistributedLockManager distributedLockManager, IRequestSupplement supplement, IRepository<PosmInvestment, int> posmInvestmentRepository) : base(supplement)
        {
        ...
        public async Task<Unit> Handle(PosmInvestmentRsmDenyCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                await posmInvestment.ApplyActionAsync(new PosmInvestmentRsmDenyRequestAction(
                    IocResolver,
                    LocalizationSource,
                    requestData.Note));
