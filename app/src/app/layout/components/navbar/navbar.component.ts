...
export class NavbarComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.suppertLanguages = localizationService
      .getSupportLanguages()
      .filter((p) => p == "vi");
  ...
  logout() {
    ...
    document.location.href = this.platformLocation.getBaseHrefFromDOM();
  }
  ...
  showChangePassword() {
    this.dialogService.open(ChangePasswordDialogComponent, {
      header: this.localizationService.get("change_password"),
      baseZIndex: 1050,
    });
  }
  /**
