...
@Component({
  selector: "report-posm-investment-request",
  templateUrl: "./posm-investment-request.component.html",
  styleUrls: ["./posm-investment-request.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportPosmInvestmentRequestComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_posm_investment_request",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_posm_investment_request",
          isLink: true,
          link: "/report/posm-investment/request",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      ...
      "RP_PosmInvestment_Request",
      JSON.stringify({
        store: "RP_PosmInvestment_Request",
        storeParams: [
          {
