...
@Component({
  selector: "report-posm-investment-order",
  templateUrl: "./posm-investment-order.component.html",
  styleUrls: ["./posm-investment-order.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportPosmInvestmentOrderComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_posm_investment_order",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_posm_investment_order",
          isLink: true,
          link: "/report/posm-investment/order",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      this.l("report_posm_investment_order"),
      "RP_PosmInvestment_Order",
      JSON.stringify({
        store: "RP_PosmInvestment_Order",
        storeParams: [
          {
