...
@Component({
  selector: "report-posm-investment-produce",
  templateUrl: "./posm-investment-produce.component.html",
  styleUrls: ["./posm-investment-produce.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportPosmInvestmentProduceComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_posm_investment_produce",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_posm_investment_produce",
          isLink: true,
          link: "/report/posm-investment/produce",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      this.l("report_posm_investment_produce"),
      "RP_PosmInvestment_Produce",
      JSON.stringify({
        store: "RP_PosmInvestment_Produce",
        storeParams: [
          {
