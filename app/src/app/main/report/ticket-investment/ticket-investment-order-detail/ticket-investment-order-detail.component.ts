...
@Component({
  selector: "ticket-investment-order-detail",
  templateUrl: "./ticket-investment-order-detail.component.html",
  styleUrls: ["./ticket-investment-order-detail.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportTicketInvestmentOrderDetailComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_ticket_investment_order_detail",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_ticket_investment_order_detail",
          isLink: true,
          link: "/report/ticket-investment/order-detail",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      this.l("report_ticket_investment_order_detail"),
      "RP_TicketInvestment_Order_Detail",
      JSON.stringify({
        store: "RP_TicketInvestment_Order_Detail",
        storeParams: [
          {
