...
@Component({
  selector: "report-ticket-investment-remark",
  templateUrl: "./ticket-investment-remark.component.html",
  styleUrls: ["./ticket-investment-remark.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportTicketInvestmentRemarkComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_ticket_investment_remark",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_ticket_investment_remark",
          isLink: true,
          link: "/report/ticket-investment/remark",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      this.l("report_ticket_investment_remark"),
      "RP_TicketInvestment_Remark",
      JSON.stringify({
        store: "RP_TicketInvestment_Remark",
        storeParams: [
          {
