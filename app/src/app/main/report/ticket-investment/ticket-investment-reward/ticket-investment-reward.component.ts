...
@Component({
  selector: "report-ticket-investment-reward",
  templateUrl: "./ticket-investment-reward.component.html",
  styleUrls: ["./ticket-investment-reward.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportTicketInvestmentRewardComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_ticket_investment_reward",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_ticket_investment_reward",
          isLink: true,
          link: "/report/ticket-investment/reward",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      this.l("report_ticket_investment_reward"),
      "RP_TicketInvestment_Reward",
      JSON.stringify({
        store: "RP_TicketInvestment_Reward",
        storeParams: [
          {
