...
@Component({
  selector: "report-ticket-investment-ticket",
  templateUrl: "./ticket-investment-ticket.component.html",
  styleUrls: ["./ticket-investment-ticket.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportTicketInvestmentTicketComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_ticket_investment_ticket",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_ticket_investment_ticket",
          isLink: true,
          link: "/report/ticket-investment/ticket",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      ...
      "RP_TicketInvestment_Ticket",
      JSON.stringify({
        store: "RP_TicketInvestment_Ticket",
        storeParams: [
          {
