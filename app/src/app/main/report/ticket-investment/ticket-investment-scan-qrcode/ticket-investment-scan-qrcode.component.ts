...
@Component({
  selector: "report-ticket-investment-scan-qrcode",
  templateUrl: "./ticket-investment-scan-qrcode.component.html",
  styleUrls: ["./ticket-investment-scan-qrcode.component.scss"],
  encapsulation: ViewEncapsulation.None,
})
export class ReportTicketInvestmentScanQrCodeComponent extends FormComponentBase {
  //#region Variables
  //#endregion
  contentHeader = {
    headerTitle: "report_ticket_investment_scan_qrcode",
    actionButton: false,
    breadcrumb: {
      type: "",
      links: [
        ...
        {
          name: "report_ticket_investment_scan_qrcode",
          isLink: true,
          link: "/report/ticket-investment/scan-qrcode",
        },
      ],
    },
  };
  ...
  printPreview() {
    ...
    this.reportService.openReport(
      this.l("report_ticket_investment_scan_qrcode"),
      "RP_TicketInvestment_ScanQrCode",
      JSON.stringify({
        store: "RP_TicketInvestment_ScanQrCode",
        storeParams: [
          {
