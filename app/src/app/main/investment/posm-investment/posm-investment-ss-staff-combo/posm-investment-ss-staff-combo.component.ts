...
//#endregion
@Component({
  selector: "app-posm-investment-ss-staff-combo",
  templateUrl: "./posm-investment-ss-staff-combo.component.html",
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: PosmInvestmentSSStaffComboComponent,
    },
  ],
})
export class PosmInvestmentSSStaffComboComponent extends ComboComponentBase {
  //#region Variables
