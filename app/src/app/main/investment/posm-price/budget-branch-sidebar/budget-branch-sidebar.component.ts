...
//#endregion
@Component({
  selector: "app-budget-branch-sidebar",
  templateUrl: "./budget-branch-sidebar.component.html",
  styleUrls: ["./budget-branch-sidebar.component.scss"],
})
export class BudgetBranchSidebarComponent
  extends SidebarEditGridComponentBase<BudgetBranchDto>
  implements OnInit
{
  //#region Variables
  @BlockUI("budget_branch_content_block") formBlockUI: NgBlockUI;
  ...
  get saveVisible(): boolean {
    return (
      ["Budgets", "Budgets.AllocateArea", "Budgets.AllocateBranch"].find((p) =>
        this.isGranted(p)
      ) != undefined
    );
  }
