...
//#endregion
@Component({
  selector: "app-ss-staff-combo",
  templateUrl: "./ss-staff-combo.component.html",
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      multi: true,
      useExisting: SSStaffComboComponent,
    },
  ],
})
export class SSStaffComboComponent extends ComboComponentBase {
  //#region Variables
